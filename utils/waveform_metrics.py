'''
https://github.com/AllenInstitute/ecephys_spike_sorting/tree/archive/ecephys_spike_sorting/modules/mean_waveforms

Metrics are computed for a waveform, and include features of the 1D peak-channel waveform and the 2D waveform centered on the soma location.

Adapted from Jia et al. (2019) "High-density extracellular probes reveal dendritic backpropagation and facilitate neuron classification." J Neurophys 121: 1831-1847
'''
