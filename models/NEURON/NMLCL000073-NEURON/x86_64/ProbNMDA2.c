...
#define tau_r_NMDA _p[0]
#define tau_d_NMDA _p[1]
#define Use _p[2]
#define Dep _p[3]
#define Fac _p[4]
#define e _p[5]
...
#define DA_NMDA _p[15]
#define DB_NMDA _p[16]
#define _g _p[17]
#define _tsav _p[18]
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 94 in file ProbNMDA2.mod:\n        SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/kedoxey/CRCNS/PyramidalCellSimulations/models/NEURON/NMLCL000073-NEURON/ProbNMDA2.mod";
static const char* nmodl_file_text = 
  ...
  "        Dep = 100   (ms)  : relaxation time constant from depression 100\n"
  "        Fac = 10   (ms)  :  relaxation time constant from facilitation 10\n"
