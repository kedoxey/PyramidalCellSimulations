...
#define m_forwardRate_x _ml->template fpfield<10>(_iml)
...
#define m_rateScale _ml->template fpfield<13>(_iml)
#define m_rateScale_columnindex 13
#define m_alpha _ml->template fpfield<14>(_iml)
#define m_alpha_columnindex 14
#define m_beta _ml->template fpfield<15>(_iml)
#define m_beta_columnindex 15
#define m_fcond _ml->template fpfield<16>(_iml)
#define m_fcond_columnindex 16
#define m_inf _ml->template fpfield<17>(_iml)
#define m_inf_columnindex 17
#define m_tau _ml->template fpfield<18>(_iml)
#define m_tau_columnindex 18
#define conductanceScale _ml->template fpfield<19>(_iml)
#define conductanceScale_columnindex 19
#define fopen0 _ml->template fpfield<20>(_iml)
#define fopen0_columnindex 20
#define fopen _ml->template fpfield<21>(_iml)
#define fopen_columnindex 21
#define g _ml->template fpfield<22>(_iml)
#define g_columnindex 22
#define m_q _ml->template fpfield<23>(_iml)
#define m_q_columnindex 23
#define temperature _ml->template fpfield<24>(_iml)
#define temperature_columnindex 24
#define eh _ml->template fpfield<25>(_iml)
#define eh_columnindex 25
#define ih _ml->template fpfield<26>(_iml)
#define ih_columnindex 26
#define rate_m_q _ml->template fpfield<27>(_iml)
#define rate_m_q_columnindex 27
#define Dm_q _ml->template fpfield<28>(_iml)
...
#define _ion_ih *(_ml->dptr_field<0>(_iml))
#define _p_ion_ih static_cast<neuron::container::data_handle<double>>(_ppvar[0])
#define _ion_dihdv *(_ml->dptr_field<1>(_iml))
...
"Ih",
 ...
 static _nrn_mechanism_std_vector<double> _parm_default{
     ...
     1e-05, /* conductance */
     1, /* m_instances */
     0.076517, /* m_forwardRate_rate */
     -154.9, /* m_forwardRate_midpoint */
     -11.9, /* m_forwardRate_scale */
     0.193, /* m_reverseRate_rate */
     0, /* m_reverseRate_midpoint */
     33.1, /* m_reverseRate_scale */
 }; 
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 3, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 31);
 	...
 	m_forwardRate_rate = _parm_default[3]; /* 0.076517 */
 	m_forwardRate_midpoint = _parm_default[4]; /* -154.9 */
 	m_forwardRate_scale = _parm_default[5]; /* -11.9 */
 	m_reverseRate_rate = _parm_default[6]; /* 0.193 */
 	m_reverseRate_midpoint = _parm_default[7]; /* 0 */
 	m_reverseRate_scale = _parm_default[8]; /* 33.1 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 31);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 	/*connect ionic variables to this model*/
 prop_ion = need_memb(_h_sym);
 	_ppvar[0] = _nrn_mechanism_get_param_handle(prop_ion, 3); /* ih */
 	_ppvar[1] = _nrn_mechanism_get_param_handle(prop_ion, 4); /* _ion_dihdv */
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"m_forwardRate_x"} /* 10 */,
                                       _nrn_mechanism_field<double>{"m_forwardRate_r"} /* 11 */,
                                       _nrn_mechanism_field<double>{"m_reverseRate_r"} /* 12 */,
                                       _nrn_mechanism_field<double>{"m_rateScale"} /* 13 */,
                                       _nrn_mechanism_field<double>{"m_alpha"} /* 14 */,
                                       _nrn_mechanism_field<double>{"m_beta"} /* 15 */,
                                       _nrn_mechanism_field<double>{"m_fcond"} /* 16 */,
                                       _nrn_mechanism_field<double>{"m_inf"} /* 17 */,
                                       _nrn_mechanism_field<double>{"m_tau"} /* 18 */,
                                       _nrn_mechanism_field<double>{"conductanceScale"} /* 19 */,
                                       _nrn_mechanism_field<double>{"fopen0"} /* 20 */,
                                       _nrn_mechanism_field<double>{"fopen"} /* 21 */,
                                       _nrn_mechanism_field<double>{"g"} /* 22 */,
                                       _nrn_mechanism_field<double>{"m_q"} /* 23 */,
                                       _nrn_mechanism_field<double>{"temperature"} /* 24 */,
                                       _nrn_mechanism_field<double>{"eh"} /* 25 */,
                                       _nrn_mechanism_field<double>{"ih"} /* 26 */,
                                       _nrn_mechanism_field<double>{"rate_m_q"} /* 27 */,
                                       _nrn_mechanism_field<double>{"Dm_q"} /* 28 */,
                                       _nrn_mechanism_field<double>{"v"} /* 29 */,
                                       _nrn_mechanism_field<double>{"_g"} /* 30 */,
                                       _nrn_mechanism_field<double*>{"_ion_ih", "h_ion"} /* 0 */,
                                       _nrn_mechanism_field<double*>{"_ion_dihdv", "h_ion"} /* 1 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Ih /home/kedoxey/CRCNS/PyramidalCellSimulations/models/NEURON/NMLCL000073-NEURON/Ih.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "Mod file for component: Component(id=Ih type=ionChannelHH)";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/kedoxey/CRCNS/PyramidalCellSimulations/models/NEURON/NMLCL000073-NEURON/Ih.mod";
