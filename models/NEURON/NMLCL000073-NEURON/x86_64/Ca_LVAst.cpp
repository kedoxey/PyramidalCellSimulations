...
static constexpr auto number_of_floating_point_variables = 50;
namespace {
template <typename T>
...
#define m_q10Settings_fixedQ10 _ml->template fpfield<8>(_iml)
...
#define h_timeCourse_TIME_SCALE _ml->template fpfield<10>(_iml)
#define h_timeCourse_TIME_SCALE_columnindex 10
#define h_timeCourse_VOLT_SCALE _ml->template fpfield<11>(_iml)
#define h_timeCourse_VOLT_SCALE_columnindex 11
#define h_steadyState_rate _ml->template fpfield<12>(_iml)
#define h_steadyState_rate_columnindex 12
#define h_steadyState_midpoint _ml->template fpfield<13>(_iml)
#define h_steadyState_midpoint_columnindex 13
#define h_steadyState_scale _ml->template fpfield<14>(_iml)
#define h_steadyState_scale_columnindex 14
#define h_q10Settings_fixedQ10 _ml->template fpfield<15>(_iml)
#define h_q10Settings_fixedQ10_columnindex 15
#define gion _ml->template fpfield<16>(_iml)
#define gion_columnindex 16
#define m_timeCourse_V _ml->template fpfield<17>(_iml)
#define m_timeCourse_V_columnindex 17
#define m_timeCourse_t _ml->template fpfield<18>(_iml)
#define m_timeCourse_t_columnindex 18
#define m_steadyState_x _ml->template fpfield<19>(_iml)
#define m_steadyState_x_columnindex 19
#define m_q10Settings_q10 _ml->template fpfield<20>(_iml)
#define m_q10Settings_q10_columnindex 20
#define m_rateScale _ml->template fpfield<21>(_iml)
#define m_rateScale_columnindex 21
#define m_fcond _ml->template fpfield<22>(_iml)
#define m_fcond_columnindex 22
#define m_inf _ml->template fpfield<23>(_iml)
#define m_inf_columnindex 23
#define m_tauUnscaled _ml->template fpfield<24>(_iml)
#define m_tauUnscaled_columnindex 24
#define m_tau _ml->template fpfield<25>(_iml)
#define m_tau_columnindex 25
#define h_timeCourse_V _ml->template fpfield<26>(_iml)
#define h_timeCourse_V_columnindex 26
#define h_timeCourse_t _ml->template fpfield<27>(_iml)
#define h_timeCourse_t_columnindex 27
#define h_steadyState_x _ml->template fpfield<28>(_iml)
#define h_steadyState_x_columnindex 28
#define h_q10Settings_q10 _ml->template fpfield<29>(_iml)
#define h_q10Settings_q10_columnindex 29
#define h_rateScale _ml->template fpfield<30>(_iml)
...
#define h_tauUnscaled _ml->template fpfield<33>(_iml)
#define h_tauUnscaled_columnindex 33
#define h_tau _ml->template fpfield<34>(_iml)
#define h_tau_columnindex 34
#define conductanceScale _ml->template fpfield<35>(_iml)
#define conductanceScale_columnindex 35
#define fopen0 _ml->template fpfield<36>(_iml)
#define fopen0_columnindex 36
#define fopen _ml->template fpfield<37>(_iml)
#define fopen_columnindex 37
#define g _ml->template fpfield<38>(_iml)
#define g_columnindex 38
#define m_q _ml->template fpfield<39>(_iml)
#define m_q_columnindex 39
#define h_q _ml->template fpfield<40>(_iml)
#define h_q_columnindex 40
#define temperature _ml->template fpfield<41>(_iml)
#define temperature_columnindex 41
#define eca _ml->template fpfield<42>(_iml)
#define eca_columnindex 42
#define ica _ml->template fpfield<43>(_iml)
#define ica_columnindex 43
#define rate_m_q _ml->template fpfield<44>(_iml)
#define rate_m_q_columnindex 44
#define rate_h_q _ml->template fpfield<45>(_iml)
#define rate_h_q_columnindex 45
#define Dm_q _ml->template fpfield<46>(_iml)
#define Dm_q_columnindex 46
#define Dh_q _ml->template fpfield<47>(_iml)
...
"Ca_LVAst",
 ...
 static _nrn_mechanism_std_vector<double> _parm_default{
     ...
     -40, /* m_steadyState_midpoint */
     6, /* m_steadyState_scale */
     2.95288, /* m_q10Settings_fixedQ10 */
     1, /* h_instances */
     1, /* h_timeCourse_TIME_SCALE */
     1, /* h_timeCourse_VOLT_SCALE */
     1, /* h_steadyState_rate */
     -90, /* h_steadyState_midpoint */
     -6.4, /* h_steadyState_scale */
...
static void nrn_alloc(Prop* _prop) {
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 4, _prop);
    ...
    size_t const _iml{};
    assert(_nrn_mechanism_get_num_vars(_prop) == 50);
 	...
 	m_steadyState_midpoint = _parm_default[6]; /* -40 */
 	m_steadyState_scale = _parm_default[7]; /* 6 */
 	m_q10Settings_fixedQ10 = _parm_default[8]; /* 2.95288 */
 	h_instances = _parm_default[9]; /* 1 */
 	h_timeCourse_TIME_SCALE = _parm_default[10]; /* 1 */
 	h_timeCourse_VOLT_SCALE = _parm_default[11]; /* 1 */
 	h_steadyState_rate = _parm_default[12]; /* 1 */
 	h_steadyState_midpoint = _parm_default[13]; /* -90 */
 	h_steadyState_scale = _parm_default[14]; /* -6.4 */
 	h_q10Settings_fixedQ10 = _parm_default[15]; /* 2.95288 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 50);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"m_q10Settings_fixedQ10"} /* 8 */,
                                       _nrn_mechanism_field<double>{"h_instances"} /* 9 */,
                                       _nrn_mechanism_field<double>{"h_timeCourse_TIME_SCALE"} /* 10 */,
                                       _nrn_mechanism_field<double>{"h_timeCourse_VOLT_SCALE"} /* 11 */,
                                       _nrn_mechanism_field<double>{"h_steadyState_rate"} /* 12 */,
                                       _nrn_mechanism_field<double>{"h_steadyState_midpoint"} /* 13 */,
                                       _nrn_mechanism_field<double>{"h_steadyState_scale"} /* 14 */,
                                       _nrn_mechanism_field<double>{"h_q10Settings_fixedQ10"} /* 15 */,
                                       _nrn_mechanism_field<double>{"gion"} /* 16 */,
                                       _nrn_mechanism_field<double>{"m_timeCourse_V"} /* 17 */,
                                       _nrn_mechanism_field<double>{"m_timeCourse_t"} /* 18 */,
                                       _nrn_mechanism_field<double>{"m_steadyState_x"} /* 19 */,
                                       _nrn_mechanism_field<double>{"m_q10Settings_q10"} /* 20 */,
                                       _nrn_mechanism_field<double>{"m_rateScale"} /* 21 */,
                                       _nrn_mechanism_field<double>{"m_fcond"} /* 22 */,
                                       _nrn_mechanism_field<double>{"m_inf"} /* 23 */,
                                       _nrn_mechanism_field<double>{"m_tauUnscaled"} /* 24 */,
                                       _nrn_mechanism_field<double>{"m_tau"} /* 25 */,
                                       _nrn_mechanism_field<double>{"h_timeCourse_V"} /* 26 */,
                                       _nrn_mechanism_field<double>{"h_timeCourse_t"} /* 27 */,
                                       _nrn_mechanism_field<double>{"h_steadyState_x"} /* 28 */,
                                       _nrn_mechanism_field<double>{"h_q10Settings_q10"} /* 29 */,
                                       _nrn_mechanism_field<double>{"h_rateScale"} /* 30 */,
                                       _nrn_mechanism_field<double>{"h_fcond"} /* 31 */,
                                       _nrn_mechanism_field<double>{"h_inf"} /* 32 */,
                                       _nrn_mechanism_field<double>{"h_tauUnscaled"} /* 33 */,
                                       _nrn_mechanism_field<double>{"h_tau"} /* 34 */,
                                       _nrn_mechanism_field<double>{"conductanceScale"} /* 35 */,
                                       _nrn_mechanism_field<double>{"fopen0"} /* 36 */,
                                       _nrn_mechanism_field<double>{"fopen"} /* 37 */,
                                       _nrn_mechanism_field<double>{"g"} /* 38 */,
                                       _nrn_mechanism_field<double>{"m_q"} /* 39 */,
                                       _nrn_mechanism_field<double>{"h_q"} /* 40 */,
                                       _nrn_mechanism_field<double>{"temperature"} /* 41 */,
                                       _nrn_mechanism_field<double>{"eca"} /* 42 */,
                                       _nrn_mechanism_field<double>{"ica"} /* 43 */,
                                       _nrn_mechanism_field<double>{"rate_m_q"} /* 44 */,
                                       _nrn_mechanism_field<double>{"rate_h_q"} /* 45 */,
                                       _nrn_mechanism_field<double>{"Dm_q"} /* 46 */,
                                       _nrn_mechanism_field<double>{"Dh_q"} /* 47 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Ca_LVAst /home/kedoxey/CRCNS/PyramidalCellSimulations/models/NEURON/NMLCL000073-NEURON/Ca_LVAst.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "Mod file for component: Component(id=Ca_LVAst type=ionChannelHH)";
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_Ca_LVAst. Requires prior call to setdata_Ca_LVAst and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/kedoxey/CRCNS/PyramidalCellSimulations/models/NEURON/NMLCL000073-NEURON/Ca_LVAst.mod";
