...
#define Vwt _ml->template fpfield<4>(_iml)
...
#define factor _ml->template fpfield<9>(_iml)
#define factor_columnindex 9
#define etime _ml->template fpfield<10>(_iml)
  ...
  if (nrn_point_prop_) {
   ...
   _ppvar = nrn_prop_datum_alloc(_mechtype, 3, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 16);
 	...
 	e = _parm_default[2]; /* 0 */
 	gmax = _parm_default[3]; /* 1e+09 */
 	Vwt = _parm_default[4]; /* 0 */
  }
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 16);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _MyExp2SynBB_reg() {
	int _vectorized = 1;
  _initlists();
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"Vwt"} /* 4 */,
                                       ...
                                       _nrn_mechanism_field<double>{"factor"} /* 9 */,
                                       _nrn_mechanism_field<double>{"etime"} /* 10 */,
 ...
 pnt_receive_size[_mechtype] = 1;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 MyExp2SynBB /home/kedoxey/CRCNS/PyramidalCellSimulations/models/NEURON/NMLCL000073-NEURON/MyExp2SynBB.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/kedoxey/CRCNS/PyramidalCellSimulations/models/NEURON/NMLCL000073-NEURON/MyExp2SynBB.mod";
