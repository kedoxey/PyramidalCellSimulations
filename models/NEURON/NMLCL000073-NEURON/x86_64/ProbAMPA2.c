...
#define DA_AMPA _p[14]
#define DB_AMPA _p[15]
#define _g _p[16]
#define _tsav _p[17]
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 93 in file ProbAMPA2.mod:\n        SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/kedoxey/CRCNS/PyramidalCellSimulations/models/NEURON/NMLCL000073-NEURON/ProbAMPA2.mod";
static const char* nmodl_file_text = 
