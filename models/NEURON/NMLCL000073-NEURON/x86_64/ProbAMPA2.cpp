...
#define nrn_init _nrn_init__ProbAMPA2
#define _nrn_initial _nrn_initial__ProbAMPA2
#define nrn_cur _nrn_cur__ProbAMPA2
#define _nrn_current _nrn_current__ProbAMPA2
#define nrn_jacob _nrn_jacob__ProbAMPA2
#define nrn_state _nrn_state__ProbAMPA2
#define _net_receive _net_receive__ProbAMPA2 
#define setRNG setRNG__ProbAMPA2 
#define state state__ProbAMPA2 
...
#define i_AMPA _ml->template fpfield<9>(_iml)
#define i_AMPA_columnindex 9
#define g_AMPA _ml->template fpfield<10>(_iml)
#define g_AMPA_columnindex 10
#define A_AMPA _ml->template fpfield<11>(_iml)
#define A_AMPA_columnindex 11
#define B_AMPA _ml->template fpfield<12>(_iml)
#define B_AMPA_columnindex 12
#define factor_AMPA _ml->template fpfield<13>(_iml)
#define factor_AMPA_columnindex 13
#define DA_AMPA _ml->template fpfield<14>(_iml)
#define DA_AMPA_columnindex 14
#define DB_AMPA _ml->template fpfield<15>(_iml)
#define DB_AMPA_columnindex 15
...
#define erand erand_ProbAMPA2
 extern double erand( );
 /* declare global and static user variables */
 #define gind 0
 #define _gth 0
#define mggate mggate_ProbAMPA2
 double mggate = 0;
#define mg mg_ProbAMPA2
 double mg = 1;
 ...
 {"mg_ProbAMPA2", &mg_ProbAMPA2},
 {"mggate_ProbAMPA2", &mggate_ProbAMPA2},
 {0, 0}
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"i_AMPA"} /* 9 */,
                                       _nrn_mechanism_field<double>{"g_AMPA"} /* 10 */,
                                       _nrn_mechanism_field<double>{"A_AMPA"} /* 11 */,
                                       _nrn_mechanism_field<double>{"B_AMPA"} /* 12 */,
                                       _nrn_mechanism_field<double>{"factor_AMPA"} /* 13 */,
                                       _nrn_mechanism_field<double>{"DA_AMPA"} /* 14 */,
                                       _nrn_mechanism_field<double>{"DB_AMPA"} /* 15 */,
 ...
 pnt_receive_size[_mechtype] = 6;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 ProbAMPA2 /home/kedoxey/CRCNS/PyramidalCellSimulations/models/NEURON/NMLCL000073-NEURON/ProbAMPA2.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "AMPA receptor with presynaptic short-term plasticity ";
 ...
 v=_v;
{
 { error =  state();
 if(error){
  std_cerr_stream << "at line 92 in file ProbAMPA2.mod:\n\n";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/kedoxey/CRCNS/PyramidalCellSimulations/models/NEURON/NMLCL000073-NEURON/ProbAMPA2.mod";
