  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 8, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 15);
 	...
 	gamma = _parm_default[0]; /* 0.000501 */
 	minCai = _parm_default[1]; /* 0.0001 */
 	decay = _parm_default[2]; /* 460 */
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _CaDynamics_E2_NML2__decay460__gamma5_01Emin4_reg() {
	int _vectorized = 0;
  _initlists();
 	ion_reg("ca", 2.0);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "area");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 CaDynamics_E2_NML2__decay460__gamma5_01Emin4 /home/kedoxey/CRCNS/PyramidalCellSimulations/models/NEURON/NMLCL000073-NEURON/CaDynamics_E2_NML2__decay460__gamma5_01Emin4.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "Mod file for component: Component(id=CaDynamics_E2_NML2__decay460__gamma5_01Emin4 type=concentrationModelHayEtAl)";
...
static void _hoc_rates(void) {
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_CaDynamics_E2_NML2__decay460__gamma5_01Emin4. Requires prior call to setdata_CaDynamics_E2_NML2__decay460__gamma5_01Emin4 and that the specified mechanism instance still be in existence.", NULL);
  } else {
 ...
 v=_v;
{
 ...
 { error =  states();
 if(error){
  std_cerr_stream << "at line 90 in file CaDynamics_E2_NML2__decay460__gamma5_01Emin4.mod:\n    \n";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/kedoxey/CRCNS/PyramidalCellSimulations/models/NEURON/NMLCL000073-NEURON/CaDynamics_E2_NML2__decay460__gamma5_01Emin4.mod";
