...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 7;
 	...
 	ivoc_help("help ?1 ProbAMPANMDA2 /home/kedoxey/CRCNS/PyramidalCellSimulations/models/NEURON/NMLCL001535-NEURON/ProbAMPANMDA2.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 106 in file ProbAMPANMDA2.mod:\n        SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/kedoxey/CRCNS/PyramidalCellSimulations/models/NEURON/NMLCL001535-NEURON/ProbAMPANMDA2.mod";
static const char* nmodl_file_text = 
