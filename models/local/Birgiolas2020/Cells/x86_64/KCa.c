...
#define _f_concdep _f_concdep__KCa 
#define _f_vdep _f_vdep__KCa 
#define concdep concdep__KCa 
#define rate rate__KCa 
#define state state__KCa 
#define vdep vdep__KCa 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 KCa /home/kedoxey/CRCNS/PyramidalCellSimulations/models/local/Birgiolas2020/Mechanisms/KCa.mod\n");
 ...
 v=_v;
{
  ...
  cai = _ion_cai;
 { error =  state();
 if(error){fprintf(stderr,"at line 49 in file KCa.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/kedoxey/CRCNS/PyramidalCellSimulations/models/local/Birgiolas2020/Mechanisms/KCa.mod";
static const char* nmodl_file_text = 
