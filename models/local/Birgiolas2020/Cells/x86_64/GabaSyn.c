...
#define plast plast_GabaSyn
 extern double plast( _threadargsprotocomma_ double );
 /* declare global and static user variables */
#define sigslope sigslope_GabaSyn
 double sigslope = 10;
#define sighalf sighalf_GabaSyn
 double sighalf = 50;
 ...
 "sighalf_GabaSyn", &sighalf_GabaSyn,
 "sigslope_GabaSyn", &sigslope_GabaSyn,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 4;
 	...
 	ivoc_help("help ?1 GabaSyn /home/kedoxey/CRCNS/PyramidalCellSimulations/models/local/Birgiolas2020/Mechanisms/GabaSyn.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/kedoxey/CRCNS/PyramidalCellSimulations/models/local/Birgiolas2020/Mechanisms/GabaSyn.mod";
static const char* nmodl_file_text = 
  "\n"
  "COMMENT\n"
