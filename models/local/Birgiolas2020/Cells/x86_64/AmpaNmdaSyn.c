...
#define nrn_init _nrn_init__AmpaNmdaSyn
#define _nrn_initial _nrn_initial__AmpaNmdaSyn
#define nrn_cur _nrn_cur__AmpaNmdaSyn
#define _nrn_current _nrn_current__AmpaNmdaSyn
#define nrn_jacob _nrn_jacob__AmpaNmdaSyn
#define nrn_state _nrn_state__AmpaNmdaSyn
#define _net_receive _net_receive__AmpaNmdaSyn 
#define release release__AmpaNmdaSyn 
...
#define _f_mgblock _f_mgblock_AmpaNmdaSyn
#define mgblock mgblock_AmpaNmdaSyn
#define plast plast_AmpaNmdaSyn
...
#define Alpha Alpha_AmpaNmdaSyn
 double Alpha = 0.35;
#define Beta Beta_AmpaNmdaSyn
 double Beta = 0.035;
#define Cdur Cdur_AmpaNmdaSyn
 double Cdur = 1;
#define E E_AmpaNmdaSyn
 double E = 0;
#define Rtau Rtau_AmpaNmdaSyn
 double Rtau = 0;
#define Rinf Rinf_AmpaNmdaSyn
 double Rinf = 0;
#define ampatau ampatau_AmpaNmdaSyn
 double ampatau = 3;
#define gampafactor gampafactor_AmpaNmdaSyn
 double gampafactor = 0.001;
#define sigslope sigslope_AmpaNmdaSyn
 double sigslope = 10;
#define sighalf sighalf_AmpaNmdaSyn
 double sighalf = 50;
#define usetable usetable_AmpaNmdaSyn
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_AmpaNmdaSyn", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "Cdur_AmpaNmdaSyn", "ms",
 "Alpha_AmpaNmdaSyn", "/ms",
 "Beta_AmpaNmdaSyn", "/ms",
 "E_AmpaNmdaSyn", "mV",
 "gampafactor_AmpaNmdaSyn", "1",
 "sighalf_AmpaNmdaSyn", "1",
 "sigslope_AmpaNmdaSyn", "1",
 "ampatau_AmpaNmdaSyn", "ms",
 "Rtau_AmpaNmdaSyn", "ms",
 "mg", "mM",
 "gmax", "umho",
 "nmdafactor", "1",
 ...
 "Cdur_AmpaNmdaSyn", &Cdur_AmpaNmdaSyn,
 "Alpha_AmpaNmdaSyn", &Alpha_AmpaNmdaSyn,
 "Beta_AmpaNmdaSyn", &Beta_AmpaNmdaSyn,
 "E_AmpaNmdaSyn", &E_AmpaNmdaSyn,
 "gampafactor_AmpaNmdaSyn", &gampafactor_AmpaNmdaSyn,
 "sighalf_AmpaNmdaSyn", &sighalf_AmpaNmdaSyn,
 "sigslope_AmpaNmdaSyn", &sigslope_AmpaNmdaSyn,
 "ampatau_AmpaNmdaSyn", &ampatau_AmpaNmdaSyn,
 "Rinf_AmpaNmdaSyn", &Rinf_AmpaNmdaSyn,
 "Rtau_AmpaNmdaSyn", &Rtau_AmpaNmdaSyn,
 "usetable_AmpaNmdaSyn", &usetable_AmpaNmdaSyn,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 6;
 	...
 	ivoc_help("help ?1 AmpaNmdaSyn /home/kedoxey/CRCNS/PyramidalCellSimulations/models/local/Birgiolas2020/Mechanisms/AmpaNmdaSyn.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/kedoxey/CRCNS/PyramidalCellSimulations/models/local/Birgiolas2020/Mechanisms/AmpaNmdaSyn.mod";
static const char* nmodl_file_text = 
